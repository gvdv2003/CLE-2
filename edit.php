...
<body>
    ...
    <nav class=sidenav>
        <svg class=logo id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 187.39 42.28">
            <defs>
                <style>
                    .cls-1,
                    .cls-2,
        ...
        <div class=sidenavContainer>
            ...
            <section class=login>
                ...
                <a href="logout.php"><svg width="95" height="90" viewBox="0 0 95 90" fill="none"
                    ...
                    <form class="column is-6" action="" method="post">
                        ...
                        <div class="field is-horizontal">
                            ...
                            <div class="field-body">
                                <div class="field">
                                    <div class="control">
                                        <input class="input" id="persons" type="number" name="persons"
                                            value="<?= htmlentities($persons) ?>" />
                                    </div>
                                    <p class="help is-danger">
                                        <?php
