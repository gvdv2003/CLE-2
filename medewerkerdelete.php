...
if(!isset($_GET['id'])){
    header('Location: medewerkeroverview.php');
    exit;
}
$index = $_GET['id'];
...
if(isset($_POST['submit'])){
    $query = "DELETE FROM users WHERE id ='$index'";
    $result = mysqli_query($db, $query);
...
<div class="container px-4">
    <div class="columns is-centered">
        <div class="column is-narrlast_nameow">
            <h2 class="title mt-4"><?= $user['first_name'].' '.$user['last_name']?></h2>
            <section class="content">
                <ul>
                    <li>voornaam: <?= $user['first_name']?></li>
                    <li>achternaam: <?= $user['last_name']?></li>
            ...
            <div>
                <a class="button" href="medewerkeroverview.php">Go back to the list</a>
            </div>
        </div>
    </div>
</div>
