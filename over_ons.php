...
<div class=container>
    <nav class=sidenav>
        ...
        <div class=sidenavContainer>
            ...
            <section class=login>
                ...
                <a href="tijdschema.php"><svg width="95" height="90" viewBox="0 0 95 90" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <main>
        ...
        <h2>Boulderen is booming!</h2>
        <p>In 2011 waren we de 2e boulderhal van Nederland, klein en knus. In de jaren daarna hebben we keer op keer een kleine uitbreiding gedaan in de zomer van 2017 hebben we onze boulderwanden flink uitgebreid, en begin 2018 hebben we een geheel nieuwe kantine gemaakt. We zijn erg blij met wat we in de loop van de tijd hebben neergezet. Kom eens langs, probeer het boulderen eens, het is echt vet gaaf!</p>
        <p>Boulderen is een zeer toegankelijke sport en door jong en oud te beoefenen. Cube Bouldergym beschikt over 600 m2 klimwand met 10 circuits van verschillende moeilijkheidsniveau's. In totaal zijn er meer dan 200 korte klimroutes (boulders). Er worden zeer regelmatig nieuwe boulders gebouwd door een vast team; Twee keer per week een half circuit van 10 boulders. Genoeg verse uitdagingen dus voor iedereen.</p>
        <p>Cube Bouldergym beschikt over een eigen bar en verkoopt tevens kleding van <a href="https://www.nihilclimbing.com" class="pagina-links">NIHIL Climbing</a> en klimschoenen van <a href="https://madrock.com" class="pagina-links">Mad Rock</a>. Daarnaast kun je bij de Cube terecht voor accessoires zoals sporttape, chalk(bags) en crashpads.</p>
        <p>Cube Bouldergym organiseert ook regionale en landelijke boulderwedstrijden en klimevenementen.</p>
        <p>De boulderhal is gevestigd op het voormalige Polaroid terrein in Enschede en is één van de participanten van The Performance Factory. Binnen het concept van The Performance Factory wordt ruimte geboden aan talentontwikkeling op het gebied van onderwijs, kunst, cultuur en sport.</p>
    </main>
