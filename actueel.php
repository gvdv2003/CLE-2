        ...
        <main>
            <article>
                ...
                <p>Vrijdag 1 september
                    Wij waren zijn op zoek naar collega's. Dit was is jouw kans om bij het fantastische Cube team te
                    horen:</p>
                <h3>Schoonmaker:</h3>
                <p>Zoek jij een leuke (bij)baan voor in de ochtend uurtjes? Kom helpen onze bouldergym schoon en fris te
                    houden. Zie jij graag direct resultaat in je werk en vind je het heerlijk om fysiek bezig te zijn,
                    dan ben jij de ideale kandidaat. is dat mooi meegenomen.</p>
                <p>Daarnaast houden we ook altijd onze ogen open voor boulderbouwers en (jeugd)trainers. Ook een open
                    solicitatie sturen mag altijd, wie weet.</p>
            </article>
            <hr style="width:100%;text-align:left;margin-left:0">
            <article>
                <h2>ICE CUBES 2023 | Saturday July 1st</h2>
                <p>Our coolest bouldering event of the year!</p>
                <p>Ice Cubes is our big summer event full of beautiful boulders (of all levels), special holds,
                    spectacular finals and a wild cocktail party.</p>
                <p>For you that means: During the day hard bouldering on 60 of the most beautiful boulders, and in the
                    evening watching a spectacular final while sipping a cocktail</p>
            </article>
            <hr style="width:100%;text-align:left;margin-left:0">
            <article>
                <h3>ICE CUBES:</h3>
                ...
                <p>We will invite some of the the best setters from the Netherlands and Germany to so set their best
                    boulders possible.

                    All the walls will be stripped of all other holds. We will have lots of volumes and a whole batch of
                    new holds to work with.

                    The event will conclude with a cocktail party and a spectacular final where the best climbers will
                    "show" what they're made of.</p>
                ...
                <p>We'll have 2 categories: Male and Female, which will have their final.
                    We will also announce the winners in the youth (< 18) and veterans (40+) categories before the
                        finals. Youth and veterans automatically take part in the adult category so they can take part
                        in the final if they're good enough.</p>
